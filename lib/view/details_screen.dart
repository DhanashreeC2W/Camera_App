...
import 'package:camera_app/view/Widgets/tap_container.dart';
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Row(
                          ...
                          children: [
                            /// BOOKMARK BUTTON
                            /// CONSUMER WIDGET FOR BOOKMARK TOGGLING

                            Consumer(
                              builder: (context, provider, child) {
                                return GestureDetector(
                                  /// ACTION TO TOGGLE BOOKMARK STATE WHEN THE CONTAINER IS TAPPED
                                  onTap: () {
                                    itemsData.toggleBookmark();
                                  },
                                  child: Container(
                                    ...
                                    /// DISPLAYING THE BOOKMARK ICON BASED ON THE CURRENT STATE
                                    child: itemsData.isBookMarked
                                        ? const Icon(
                                            /// ICON DISPLAYED WHEN BOOKMARKED
                                            Icons.bookmark,
                                            color: Colors.white,
                                          )
                                        : const Icon(
                                            /// ICON DISPLAYED WHEN NOT BOOKMARKED
